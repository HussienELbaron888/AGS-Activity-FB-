 ...
 * This file defines a function that sends a welcome email to new users.
...
import type { WelcomeEmailInput, EmailOutput } from './email-types';


/**
 * Sends a welcome email to a new user.
 * @param input - The welcome email details.
 * @returns A promise that resolves to the output of the email sending process.
 */
